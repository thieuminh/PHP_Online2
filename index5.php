...
//Lấy 5 bài viết
//Câu lệnh truy vấn
$query5 = "SELECT p.*,c.title as 'category' FROM posts p LEFT JOIN categories c ON p.category_id=c.id where p.status=1 ORDER BY p.created_at desc limit 5";
					...
					<div class="col-md-6">
						<div class="post post-thumb">
							...
							<div class="post-body">
								...
								<h3 class="post-title"><a href="blog-post1.php?id=<?php echo $post4['id']; ?>"><?php echo $post4['title']; ?></a></h3>
							</div>
						</div>
					</div>
					<!-- /post -->
					...
					<div class="col-md-4">
						<div class="post">
							...
							<div class="post-body">
								...
								<h3 class="post-title"><a href="blog-post1.php?id=<?php echo $post['id']; ?>"><?php echo $post['title'];?></a></h3>
							</div>
						</div>
					</div>
					<!-- /post -->
							...
							<div class="col-md-12">
								<div class="post post-thumb">
									...
									<div class="post-body">
										...
										<h3 class="post-title"><a href="blog-post1.php?id=<?php echo $post3['id']; ?>"><?php echo $post3['title'] ;?></a></h3>
									</div>
								</div>
							</div>
							<!-- /post -->
							...
							<div class="col-md-6">
								<div class="post">
									...
									<div class="post-body">
										...
										<h3 class="post-title"><a href="blog-post1.php?id=<?php echo $post1['id']; ?>"><?php echo $post1['title'];?></a></h3>
									</div>
								</div>
							</div>
							<!-- /post -->
					...
					<div class="col-md-4">
						...
						<div class="aside-widget">
							...
							<div class="post post-widget">
								<a class="post-img" href="blog-post.html"><img src="<?php echo $post5['thumbnail'];?>" alt=""></a>
								<div class="post-body">
									<h3 class="post-title"><a href="blog-post1.php?id=<?php echo $post5['id']; ?>"><?php echo $post5['title'];?></a></h3>
								</div>
							</div>
							<?php } ?>
