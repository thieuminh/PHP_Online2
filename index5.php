				...
				<div id="nav-fixed">
					<div class="container">
						...
						<ul class="nav-menu nav navbar-nav">
							...
							?>
								<li class="cat-<?php echo $i; ?>"><a href="category.php?id=<?php echo $category['id']; ?>"><?php echo $category['title']; ?></a></li>
							<?php $i++; if($i==5) $i=1;}?>
						</ul>
						<!-- /nav -->
					...
					<div class="col-md-6">
						<div class="post post-thumb">
							...
							<div class="post-body">
								...
								<h3 class="post-title"><a href="blog-post.html"><?php echo $post4['title']; ?></a></h3>
							</div>
						</div>
					</div>
					<!-- /post -->
